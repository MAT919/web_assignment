...
?>
        <table class="table table-striped table-dark">
            ...
            if (isset($_POST['fname_btn'])) {
                ...
                $sql = "SELECT * FROM `datas` WHERE fname = '$FirstName'";   // $resultArray  = array();  
    ...
    <?php
                    ...
                    ?>
                    <p class = "text-dark text-center display-2 py-1">Sorry No recored found for given first name </p>  
                    <?php             
              }
            }   
        }
...
?>
        ...
        <body>
            ...
            <?php
            $fname = new User_data();
            $fname->getUser('datas', $_POST['fname']);
