...
?>
        <table class="table table-striped table-dark">
            <?php
            if (isset($_POST['lname_btn'])) {
                $lname = $_POST['lname'];
                $sql = "SELECT * FROM `datas` WHERE lname = '$lname'";   // $resultArray  = array();  
    ...
    <?php
                    ...
                    ?>
                    <p class = "text-dark text-center display-2 py-1">Sorry..No record found for given last name</p>  
                    <?php             
              }
            }   
        }
...
?>
        ...
        <body>
            ...
            <?php
            $fname = new User_data();
            $fname->getUser('datas', $_POST['lname']);
