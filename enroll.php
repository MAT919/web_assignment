...
?>
        <table class="table table-striped table-dark">
            ...
            if (isset($_POST['enroll_btn'])) {
                $EnrollNumber = $_POST['enrollno'];
                $sql = "SELECT * FROM `datas` WHERE enrollno = '$EnrollNumber'";   // $resultArray  = array();  
    ...
    <?php
                    ...
                    ?>
                    <p class = "text-dark text-center display-2 py-1">Sorry No record found for given Enrollment Number </p>  
                    <?php             
              }
            }   
        }
...
?>
        ...
        <body>
            ...
            <?php
            $fname = new User_data();
            $fname->getUser('datas', $_POST['enrollno']);
