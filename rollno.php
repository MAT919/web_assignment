...
?>
        <table class="table table-striped table-dark">
            <?php
            if (isset($_POST['rollno_btn'])) {
                $rollno = $_POST['rollno'];
                $sql = "SELECT * FROM `datas` WHERE course = '$rollno'";   // $resultArray  = array();  
    ...
    <?php
                    ...
                    ?>
                    <p class = "text-dark text-center display-2 py-1">Sorry..No record found for given Roll no </p>  
                    <?php             
              }
            }   
        }
...
?>
        ...
        <body>
            ...
            <?php
            $fname = new User_data();
            $fname->getUser('datas', $_POST['rollno']);
