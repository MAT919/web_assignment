...
?>
        <table class="table table-striped table-dark">
            ...
            if (isset($_POST['city_btn'])) {
                $City = $_POST['city'];
                $sql = "SELECT * FROM `datas` WHERE city = '$City'";   // $resultArray  = array();  
    ...
    <?php
                    ...
                    ?>
                    <p class = "text-dark text-center display-2 py-1">Sorry No recored found for given city name </p>  
                    <?php             
              }
            }   
        }
...
?>
        ...
        <body>
            ...
            <?php
            $fname = new User_data();
            $fname->getUser('datas', $_POST['city']);
